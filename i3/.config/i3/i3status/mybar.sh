...
mycrypto() {
  ...
  echo -n "\"full_text\":\" $(/home/ch1co/.config/i3/i3status/crypto.py) \","
  echo -n "\"color\":\"#000000\","
...
myip_public() {
  ...
  echo -n "\"full_text\":\" $(/home/ch1co/.config/i3/i3status/ip.py) \","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
}
...
disk_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/ch1co/.config/i3/i3status/disk.py)%\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "}"
}
...
memory() {
  ...
  echo -n "\"full_text\":\"  $(/home/ch1co/.config/i3/i3status/memory.py)%\","
...
cpu_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/ch1co/.config/i3/i3status/cpu.py)% \","
  echo -n "\"background\":\"#3949AB\","
  common
  echo -n "},"
}
...
meteo() {
  ...
  echo -n "\"full_text\":\" $(/home/ch1co/.config/i3/i3status/meteo.py) \","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
}
...
do
  ...
  # TIME
    ...
    termite -e /home/ch1co/.config/i3/i3status/click_time.sh &

  # METEO
  elif [[ $line == *"name"*"id_meteo"* ]]; then
    xdg-open https://openweathermap.org/city/293396 > /dev/null &
